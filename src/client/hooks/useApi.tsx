...
export function useApi<T extends ApiEndpoints>(
  endpoint: HasRequiredParams<T> extends false ? T : never,
  config: UseSuspenseQueryOptions
): ReturnType<typeof useSuspenseQuery<ApiData<T>, Error>>;
...
export function useApi<T extends ApiEndpoints>(
  endpoint: T,
  arg2?: ApiParams<T> | UseSuspenseQueryOptions,
  arg3?: UseSuspenseQueryOptions
) {
  ...
  const queryConfig = (isSecondParamConfig ? arg2 : arg3) as UseSuspenseQueryOptions | undefined;
